...
class BaseTheme extends Core {
    ...
    _transformDownWrap(offset = 0, duration = 0) {
        if (!this.options.down.isWrapCssTranslate) {
            return;
        }
    ...
    _initUpWrap() {
        ...
        BaseTheme._changeWrapStatusClass(this.upWrap, CLASS_STATUS_DEFAULT);
    }
    ...
    _upLoaingHook(isShowUpLoading) {
        ...
        BaseTheme._changeWrapStatusClass(this.upWrap, CLASS_STATUS_LOADING);
    }
    ...
    _upLoaingEndHook(isFinishUp) {
        if (!isFinishUp) {
            ...
            BaseTheme._changeWrapStatusClass(this.upWrap, CLASS_STATUS_NOMORE);
        }
